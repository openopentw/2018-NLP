...
if __name__ == '__main__':
    ...
    # eg:
    #   NTUSD-Fin
    #       python .\8.py .\data\training_set.json .\data\test_set.json .\data\outside_data\NTUSD-Fin\NTUSD_Fin_word_v1.0.json .\output\output.csv
    #   word2vec
    #       python .\8.py .\data\training_set.json .\data\test_set.json .\data\outside_data\GoogleNews-vectors-negative300.bin .\output\output.csv
    #   GLOVE
    #       python .\8.py .\data\training_set.json .\data\test_set.json .\data\outside_data\glove.6B\glove.6b.300d.txt .\output\output.csv
    ...
    # MSE: 0.06765874525436671
    # Macro F1 (thres=0.4): 0.6180003209647085
    # Micro F1 (thres=0.4): 0.7145110410094637
    xgb_params = {
        'eta': 0.05,
        'max_depth': 6,
        'subsample': 0.6,
    ...
    y_test_class = classify(y_test, 0.4)
