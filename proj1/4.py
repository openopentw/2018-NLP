...
if __name__ == '__main__':
    ...
    # eg:
    #   NTUSD-Fin
    #       python .\4.py .\data\training_set.json .\data\test_set.json .\data\NTUSD-Fin\NTUSD_Fin_word_v1.0.json .\output\output.csv
    #   word2vec
    #       python .\4.py .\data\training_set.json .\data\test_set.json .\data\GoogleNews-vectors-negative300.bin .\output\output.csv
    #   GLOVE
    #       python .\4.py .\data\training_set.json .\data\test_set.json .\data\glove.6B\glove.6b.300d.txt .\output\output.csv
    ...
    X_train = preprocess_on_x(x_train, glove_dic)
    X_test = preprocess_on_x(x_test, glove_dic)
